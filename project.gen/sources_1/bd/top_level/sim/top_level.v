...
module top_level
  ...
  wire clk_in1_0_1;
  wire dual_ltc2656_idle;
  wire dual_ltc2656_io_csld;
  wire dual_ltc2656_io_mosi0;
  wire dual_ltc2656_io_mosi1;
  ...
  wire ext_reset_in_0_1;
  wire [127:0]sim_ltc2656_0_dac_output;
  wire sim_ltc2656_0_internal_vref;
  wire [127:0]sim_ltc2656_1_dac_output;
  wire sim_ltc2656_1_internal_vref;
  ...
  top_level_dual_ltc2656_0_0 dual_ltc2656
       (.clk(source_100mhz_sys_clk),
        ...
        .idle(dual_ltc2656_idle),
        .resetn(source_100mhz_sys_resetn),
        .spi_csld(dual_ltc2656_io_csld),
        .spi_mosi0(dual_ltc2656_io_mosi0),
        .spi_mosi1(dual_ltc2656_io_mosi1),
        .spi_sck(dual_ltc2656_io_sck),
  ...
  top_level_axil_slave_0_0 example_slave
       (.S_AXI_ARADDR({system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR,system_interconnect_M00_AXI_ARADDR}),
        ...
        .resetn(source_100mhz_sys_resetn),
        .start_stb(example_slave_start_stb));
  top_level_sim_ltc2656_0_0 sim_ltc2656_0
       (.clk(source_100mhz_sys_clk),
        .dac_output(sim_ltc2656_0_dac_output),
        .internal_vref(sim_ltc2656_0_internal_vref),
        .resetn(source_100mhz_sys_resetn),
        .spi_csld(dual_ltc2656_io_csld),
        .spi_mosi(dual_ltc2656_io_mosi0),
        .spi_sck(dual_ltc2656_io_sck));
  top_level_sim_ltc2656_0_1 sim_ltc2656_1
       (.clk(source_100mhz_sys_clk),
        .dac_output(sim_ltc2656_1_dac_output),
        .internal_vref(sim_ltc2656_1_internal_vref),
        .resetn(source_100mhz_sys_resetn),
        .spi_csld(dual_ltc2656_io_csld),
        .spi_mosi(dual_ltc2656_io_mosi1),
        .spi_sck(dual_ltc2656_io_sck));
  ...
  top_level_system_ila_0_0 system_ila
       (.clk(source_100mhz_sys_clk),
        ...
        .probe2(dual_ltc2656_io_mosi0),
        .probe3(dual_ltc2656_io_mosi1),
        .probe4(sim_ltc2656_0_internal_vref),
        .probe5(sim_ltc2656_0_dac_output[0]),
        .probe6(sim_ltc2656_1_internal_vref),
        .probe7(sim_ltc2656_1_dac_output[0]),
        .probe8(dual_ltc2656_idle),
        .probe9(example_slave_start_stb));
